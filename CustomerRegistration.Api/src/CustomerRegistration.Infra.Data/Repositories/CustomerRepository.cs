            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                using (var transaction = connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        customer.Address.CustomerId = customerId; // atribuindo o CustomerId ao endereço
                        ...
                        customer.FinancialInformation.CustomerId = customerId; // atribuindo o CustomerId às informações financeiras
